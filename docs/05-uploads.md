...
3. Se a criação devolver `upload_in_progress` (sessão do próprio usuário para o mesmo destino), o cliente recarrega as pendentes e tenta casar; se não casar (outro arquivo com o mesmo nome), o item falha com essa mensagem.
