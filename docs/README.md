...
Guia rápido para quem vai desenvolver: leia 01, 02 e 03 inteiros; consulte 04 a 07 conforme a área; 08 e 09 antes de publicar uma versão (processo em CONTRIBUTING.md, "Versões e lançamentos"). Como contribuir: [`CONTRIBUTING.md`](../CONTRIBUTING.md); como reportar uma vulnerabilidade: [`SECURITY.md`](../SECURITY.md).
