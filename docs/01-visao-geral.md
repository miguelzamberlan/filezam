...
O share guarda o caminho base-relativo e o SHA-256 do token (256 bits). Mover ou renomear a pasta invalida o link (comportamento documentado na UI). A resposta para token inexistente, expirado ou revogado é sempre o mesmo 404.
